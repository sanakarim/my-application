...
public class skybar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_skybar);
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(skybar.this, threeActivity.class);
        ...
        more_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(skybar.this, dashboard2.class);
                startActivity(intent);
            }
        });
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(skybar.this, pairs);
